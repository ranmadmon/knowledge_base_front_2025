    ...
    return (
        <nav className="navbar">
            <ul>
                ...
                {/*</logo>*/}
                <li><a style={{display:"flex", justifyContent:"center",alignItems:"center", gap:"5px", textAlign:"center"}} href="/login">Login <LoginRoundedIcon style={{fontSize:"28px", marginTop:"2px"}}/></a></li>
                <li><a style={{display:"flex", justifyContent:"center",alignItems:"center", gap:"5px", textAlign:"center"}} href="/register">Signup <RegistrationRoundedIcon style={{fontSize:"28px", marginTop:"3px"}}/></a></li>
            </ul>
        </nav>
    );
}
